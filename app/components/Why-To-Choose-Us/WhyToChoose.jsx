        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12">
              ...
              <p>
                <b>Passion for Perfection:</b> Our passion for perfection is
                evident in every project we undertake. We dont just build
                kitchens; we create environments that inspire culinary
                excellence.
              </p>
            </div>
          </div>
