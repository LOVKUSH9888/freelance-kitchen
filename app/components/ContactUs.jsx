...
import { faFacebookSquare, faInstagram, faTwitter, faHeadset, faEnvelopeOpenText, faMapMarkedAlt } from '@fortawesome/free-brands-svg-icons';
          ...
          <div className="col-lg-5 contact-info__wrapper gradient-brand-color p-5 order-lg-2">
            ...
            <ul className="contact-info__list list-style--none position-relative z-index-101">
              ...
              <li className="mb-4 pl-4">
                ...
                <div className="mt-3">
                  <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" className="text-link link--right-icon text-white">Get directions <i className="link__icon fa fa-directions"></i></a>
                </div>
              </li>
            </ul>
