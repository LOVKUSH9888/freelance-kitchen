      ...
      <div className="container p-5">
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-6">
            ...
            <p>
              Excellence: We are committed to delivering excellence in every
            ...
            <p>
              Innovation: With over three decades of experience, innovation is
            ...
            <p>
              Client-Focused Approach: Your success is our success. Our
