        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 animate-right ">
              ...
              <p>
                We Design all products and serve all our customers across
                Australia. We have a team of engineers and professionals who
                design and define the exact dimensions using the latest Computer
                Aided Design Systems to give you a flawless product. We
                continuously work with our customers to give the best possible
                products and the best price possible in different regions in
                India. We dont just sell products...
              </p>
